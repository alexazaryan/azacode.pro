...
const formTranslations = {
   ru: {
      heroBadge: "Фиксированная цена, без сюрпризов",
      h1Part1: "Нужен сайт,",
      h1Part2: "который продаёт?",
      subText:
         "Заполните форму — мы напишем вам в выбранный мессенджер в рабочее время. Ночные заявки обработаем с утра",
   ...
   uk: {
      heroBadge: "Фіксована ціна, без сюрпризів",
      h1Part1: "Потрібен сайт,",
      h1Part2: "який продає?",
      subText:
         "Заповніть форму — ми напишемо вам у обраний месенджер у робочий час. Нічні заявки обробимо вранці",
